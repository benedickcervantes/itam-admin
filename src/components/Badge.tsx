...
const STYLES: Record<string, string> = {
  ...
  LOGIN_SUCCESS: "bg-emerald-500/15 text-emerald-300 ring-emerald-500/30",
  LOGIN_FAILURE: "bg-red-500/15 text-red-300 ring-red-500/30",
  PASSWORD_VERIFY_SUCCESS: "bg-teal-500/15 text-teal-300 ring-teal-500/30",
  PASSWORD_VERIFY_FAILURE: "bg-orange-500/15 text-orange-300 ring-orange-500/30",
