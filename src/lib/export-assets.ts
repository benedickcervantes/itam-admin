...
<body>
  ...
  <div class="note">Blue headers ( * ) = required fields  |  Linked to IT Audit Register via Linked Audit  |  Tip: turn off Headers and footers in the print dialog for a clean PDF.</div>
</body>
</html>`;
